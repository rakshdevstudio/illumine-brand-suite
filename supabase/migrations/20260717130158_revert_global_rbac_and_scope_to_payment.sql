-- 1. Revert global assert_finance_admin to strict lock-down
...
-- 2. Scope the service_role bypass exclusively to the record_payment RPC
...
BEGIN
  -- 🔒 Scoped Bypass: Allow system service_role (e.g. Razorpay webhooks) 
  -- to securely record payments without elevating global privileges.
